...
<form class="formulaire" action="{{route('footer.update', $footer->id)}}" enctype="multipart/form-data" method="post" class="container mt-5 text-light">
    @csrf
    Copyright: <input class="mt-2" type="text" value="{{$footer->copyright}}" name="copyright">
