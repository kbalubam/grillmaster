...
<form class="formulaire container" action="{{route('image.update', $image->id)}}" enctype="multipart/form-data" method="post" class="container mt-5 text-light">
    @csrf
    Image 1: <input class="mt-2" type="file" value="{{$image->img1}}" name="img1">
    ...
    Image 2: <input class="mt-2" type="file" value="{{$image->img2}}" name="img2">
